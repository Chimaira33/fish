...
set(
  PROGRAMS
  ${CMAKE_CURRENT_BINARY_DIR}/fish
  ${CMAKE_CURRENT_BINARY_DIR}/fish_indent
  ${CMAKE_CURRENT_BINARY_DIR}/fish_key_reader
)
...
set(
  MANUALS
  ${CMAKE_CURRENT_BINARY_DIR}/user_doc/man/man1/fish.1
...
add_custom_command(
  ...
  DEPENDS
    ...
    ${CMAKE_CURRENT_BINARY_DIR}/fish.pc.noversion
)
...
install(DIRECTORY share/groff DESTINATION ${rel_datadir}/fish)

# CONDEMNED_PAGE is managed by the conditional above
# Building the man pages is optional: if sphinx isn't installed, they're not built
install(
  DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}/user_doc/man/man1/
...
install(
  PROGRAMS share/tools/create_manpage_completions.py share/tools/deroff.py
...
install(
  DIRECTORY
    ${CMAKE_CURRENT_BINARY_DIR}/user_doc/html/ # Trailing slash is important!
  DESTINATION ${docdir}
  OPTIONAL
)
...
if(NOT APPLE)
  ...
  install(
    FILES ${SPHINX_SRC_DIR}/python_docs_theme/static/fish.png
    DESTINATION ${rel_datadir}/pixmaps
  )
endif()
...
add_custom_target(
  build_root
  COMMAND
    DESTDIR=${BUILDROOT_DIR} ${CMAKE_COMMAND} --build
