function __fish_anypython
  ...
  # Do not consider the stub /data/data/com.termux/files/usr/bin/python3 that comes installed on Darwin to be Python
  ...
  for py in python3 python3.{12,11,10,9,8,7,6,5,4,3} python2 python2.7 python
    if set -l py_path (command -s $py)
      if string match -q /data/data/com.termux/files/usr/bin/python3 -- $py_path
