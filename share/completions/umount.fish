...
complete -c umount -s n -l no-mtab -d "Don't write to /data/data/com.termux/files/usr/etc/mtab"
...
complete -c umount -s a -l all -d "Unmount all of the file systems described in /data/data/com.termux/files/usr/etc/mtab"
...
complete -c umount -s O -l test-opts -d "Actions should only be taken on file systems with the specified options in /data/data/com.termux/files/usr/etc/fstab" -xa '(cut -d " " -f 4 /data/data/com.termux/files/usr/etc/mtab)\t"Mount option"'
